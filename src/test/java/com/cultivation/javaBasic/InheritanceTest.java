...
//    https://blog.csdn.net/abe_abd/article/details/75255577
    ...
    void should_sort() {
        ...
        PersonForEquals[] person = new PersonForEquals[]{james1990,alice1990,james1992};
        PersonForEquals[] expect = new PersonForEquals[]{alice1990, james1990, james1992};

        Arrays.sort(person);

        assertArrayEquals(expect, person);
    }
}
